...
exports.loadMatches = void 0;
var types_1 = require("../shared/types");
var node_fetch_1 = require("node-fetch");
var node_html_parser_1 = require("node-html-parser");
var configFile = require('../teamConfig.json');
/**
...
function getTableFromHTML(html) {
    ...
    var table = root.getElementsByTagName('table')
        .find(function (el) { return el.id === 'playingPlanDesktop'; });
    if (table) {
...
function loadMatches() {
    return __awaiter(this, void 0, void 0, function () {
        var opt, config, team1, team2, tablesFirstTeam, _a, tablesSecondTeam, _b, matchesFirstTeam, matchesSecondTeam;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    ...
                    matchesFirstTeam = getGamesForTeam(tablesFirstTeam);
                    matchesSecondTeam = getGamesForTeam(tablesSecondTeam);
                    console.log(matchesFirstTeam);
                    return [2 /*return*/];
            }
        });
    });
